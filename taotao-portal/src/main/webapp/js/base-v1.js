 ...
 */
function login() {
    return location.href = "http://localhost:9990/user/pageLogin";
}
function regist() {
    return location.href = "http://localhost:9990/user/showRegister";
}
...
function search(a) {
    var b = "http://localhost:9997/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
